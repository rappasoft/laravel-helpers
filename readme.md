...
This project takes the useful [Laravel helper functions](https://laravel.com/docs/helpers) and allows you to use them in Non-Laravel projects. Updated for compatibility with Laravel 10 and 11.
